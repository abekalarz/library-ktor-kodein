...
set CLASSPATH=%APP_HOME%\lib\library-ktor-kodein-all.jar

@rem Execute library-ktor-kodein
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LIBRARY_KTOR_KODEIN_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%LIBRARY_KTOR_KODEIN_EXIT_CONSOLE%" exit 1
exit /b 1
